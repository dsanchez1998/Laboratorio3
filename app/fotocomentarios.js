        ...
        <TouchableOpacity>
          <View>
            ...
            <Text style={styles.postTime}>
              Lentamente estamos llegando, a nuestro momento tan esperado!!!
            </Text>
          </View>
        </TouchableOpacity>
      </View>
  ...
  <View style={styles.commentsContainer}>
    <ScrollView style={{ maxHeight: 130 }}>
      <Text style={styles.comment}>
        <Text style={styles.commentUser}>Hanna:</Text> One piece es el mejor
        anime
      </Text>
      <Text style={styles.comment}>
        <Text style={styles.commentUser}>Víctor García:</Text> El One Piece es
        real!!!
      </Text>
      <Text style={styles.comment}>
        <Text style={styles.commentUser}>Nami:</Text> Luffy vuelve aquí
      </Text>
      <Text style={styles.comment}>
        <Text style={styles.commentUser}>Violet Myers:</Text> Mugiwara forever
      </Text>
      <Text style={styles.comment}>
        <Text style={styles.commentUser}>Sabo:</Text> Mi querido hermano menor,
        te extrañaba
      </Text>
    </ScrollView>
    <TextInput
